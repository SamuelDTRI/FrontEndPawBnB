          ...
          <div className={styles.profilePicContainer}>
            ...
            <div className={styles.noImgProfileContainer}>
              {ownerInfo.photo ? (
                ...
                <div className={styles.noImgProfileContainer}>
                  <img className={styles.imageProfileDos} src={NoPhotoProfile} alt="No hay foto de perfil" />
                  <p className={styles.textDeNoImg}>Actualiza Tu Foto De Perfil En Mi Informacion</p>
                </div>
              )}
            </div>
          )}
