      ...
      <Formik
        ...
        validate={(valores)=>{
          ...
          if(!valores.codigoPostal){
            errores.codigoPostal="Por favor ingresa un codigo Postal.";            
          }else if (!/^\d{4}$/.test(valores.codigoPostal)){
            errores.codigoPostal = "Ingresa solo numeros y no más de 4 caracteres.";
          }
          ...
          <Form className={styles.formulario}>
            ...
            <div>
              ...
              <ErrorMessage name="codigoPostal" component={() => (
                <div className={styles.error}>{errors.codigoPostal}</div>
              )} />
            </div>
